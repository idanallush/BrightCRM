...
export default function AboutPage() {
  return (
    <div className="flex flex-col gap-10">
      {/* Hero */}
      <section className="rounded-2xl bg-gradient-to-bl from-brand-light via-white to-white p-8 md:p-12">
        <div className="flex items-center gap-3 mb-4">
          <span className="flex h-12 w-12 items-center justify-center rounded-xl bg-brand text-lg font-bold text-white shadow-sm">
            B
          </span>
      ...
      <section>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          <HowStep
            icon={<MessageCircle className="h-7 w-7 text-brand" />}
            title="שולחים הודעה"
