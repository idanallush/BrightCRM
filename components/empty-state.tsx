...
export function EmptyState({ icon, title, description, action, className }: {
  ...
  return (
    <div className={cn("flex flex-col items-center justify-center gap-3 rounded-xl border border-border bg-white px-6 py-12 text-center shadow-elevation-1", className)}>
