...
export function MarkDoneButton({ taskId }: { taskId: string }) {
  ...
  return (
    <button
      ...
      disabled={pending}
      title="סמן כבוצע"
      className="flex h-9 w-9 items-center justify-center rounded-md text-ink-muted transition-colors hover:bg-[#00C875]/10 hover:text-[#00C875] disabled:opacity-50"
    >
