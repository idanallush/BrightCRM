...
export function MarkDoneButton({ taskId }: { taskId: string }) {
  ...
  return (
    <button
      ...
      disabled={pending}
      title="סמן כבוצע"
      className="flex h-9 w-9 items-center justify-center rounded-xl text-ink-muted transition-colors hover:bg-st-done-bg hover:text-success disabled:opacity-50"
    >
